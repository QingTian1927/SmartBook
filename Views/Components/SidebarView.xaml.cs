...
public partial class SidebarView : UserControl
{
    ...
    private void SidebarView_OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        AdminHomeBtn.Visibility = Visibility.Collapsed;
    }
    ...
    private void AdminCategoriesBtn_Click(object sender, RoutedEventArgs e)
    {
        MainWindow.Instance.Navigate(new ManageCategoriesView());
    }
    ...
    private void AdminHomeBtn_Click(object sender, RoutedEventArgs e)
    {
